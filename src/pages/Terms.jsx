...
const SECTIONS = [
  {
    ...
    body: 'By creating an account or using the Maddex website or Maddex Terminal, you agree to be bound by these Terms of Service. If you do not agree, please do not use the service. Maddex is operated by Madden Group Holdings Pty Ltd (ABN pending registration).',
  },
  {
    title: '2. The service',
  ...
  },
  {
    ...
    body: 'You are responsible for maintaining the confidentiality of your account credentials and for all activity that occurs under your account. Notify us immediately if you suspect unauthorised access. You must provide accurate information when creating an account and keep it up to date.',
  },
  {
    title: '5. Subscriptions and billing',
    body: 'Terminal subscriptions are billed monthly or annually in advance, in Australian dollars, and renew automatically until cancelled. You may cancel at any time from your account settings; cancellation takes effect at the end of the current billing period. A free trial, where offered, does not require a credit card and converts to a paid subscription only if you choose to subscribe. Fees paid are generally non-refundable except where required by Australian Consumer Law.',
  },
  {
  ...
  },
  {
    ...
    body: 'The Maddex name, branding, software, and all content generated by the platform (including MaddenAI outputs) remain the property of Madden Group Holdings Pty Ltd or its licensors. You may use the service for your own personal, non-commercial purposes; you may not copy, resell, or redistribute any part of the platform or its outputs without our written permission.',
  },
  {
  ...
  },
  {
    ...
    body: 'These Terms of Service are governed by the laws of Queensland, Australia. You submit to the exclusive jurisdiction of the courts of Queensland for any dispute arising from these terms or your use of the service.',
  },
  {
  ...
  {
    title: '12. Contact',
    body: 'Questions about these terms can be sent to ben@maddex.com.au.',
  },
]
