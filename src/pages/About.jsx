  ...
  return (
    <>
      ...
      <section className="bg-bg-surface py-20 px-6 md:px-10">
        <div className="max-w-[1000px] mx-auto grid grid-cols-1 md:grid-cols-[220px_1fr] gap-10 items-start">
          <motion.div
            initial={{ opacity: 0, scale: 0.9 }}
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="w-[220px] h-[220px] rounded-full bg-bg-primary border border-gold/25 flex items-center justify-center mx-auto md:mx-0 shrink-0"
          >
            <span className="font-mono text-[64px] font-bold text-gold">BM</span>
          </motion.div>
          <div>
            <span className="font-mono text-[10px] tracking-[0.2em] text-gold">FOUNDER</span>
            <h2 className="font-sans text-[26px] md:text-[32px] font-bold text-text-primary mt-2">Ben Madden</h2>
            <p className="font-sans text-[15px] text-text-muted mt-4 leading-relaxed">
      ...
      <section className="bg-bg-primary py-20 px-6 md:px-10 text-center">
        ...
        <h2 className="font-sans text-[28px] md:text-[40px] font-bold text-text-primary max-w-3xl mx-auto leading-tight">
        ...
        <div className="max-w-[1280px] mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-12">
            {[
              ...
              >
                <span className="font-mono text-[10px] tracking-[0.15em] text-gold">{title}</span>
      ...
      <section className="bg-bg-surface py-20 px-6 md:px-10">
        <div className="max-w-[800px] mx-auto">
          ...
          <h2 className="font-sans text-[28px] md:text-[36px] font-bold text-text-primary text-center leading-tight mb-12">
      ...
      <section className="bg-bg-primary py-24 px-6 md:px-10 text-center">
        ...
        <h2 className="font-sans text-[28px] md:text-[40px] font-bold text-text-primary max-w-2xl mx-auto leading-tight">
          Get in touch with Ben directly.
        </h2>
        <p className="font-sans text-[15px] text-text-muted mt-4">
